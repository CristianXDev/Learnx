...
<section id="home" class="min-h-100vh flex justify-between items-center relative mt-10 md:mt-20">
    <div class="flex flex-col justify-center w-full md:w-2/3 mx-5 md:mx-15">
        <div>
            <h1 class="white fs-l3 lh-2 md:fs-xl1 md:lh-1 fw-900">¡Visualiza videos<br> y 
                <span class="border-b bc-indigo bw-4">mejora </span> en tus examenes!</h1>
        ...
        <div class="relative flex justify-end items-center w-full md:w-1/3 px-10 md:px-20 md:ml-20"> 
            ...
            <img src="{{ asset('static/assets/img/classroom-join/bg-10.png') }}" alt="girl_vr" class="max-h-60vh object-cover md:max-h-full"> 
        </div>
    </section>
...
<section class="p-0 md-p-5">
    ...
    <div class="flex justify-center items-center mb-5" id="classroom">
        <h1 class="white fs-l3 fw-900"><span class="border-b bc-indigo bw-4">Cursos disponibles</span></h1>
    </div>

    @if ($curso->isEmpty())
        <div class="flex justify-center items-center mt-5">
            <h2 class="white">No hay cursos disponibles.</h2>
        </div>
    @else
        <div class="flex flex-wrap">
            ...
            <div class="w-100pc md-w-33pc p-10">
                <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300"> 
                    <img class="w-100pc" src="{{ Storage::url( $row->image) }}" alt="{{ $row->nombre }}">
