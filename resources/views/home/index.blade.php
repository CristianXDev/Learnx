...
<title>LearnX | ¡Encuentra tu futuro profesional con nosotros!</title>
...
<section id="home" class="min-h-100vh flex justify-between items-center relative mt-10 md:mt-20">
    <div class="flex flex-col justify-center w-full md:w-2/3 mx-5 md:mx-15">
        <div>
            <h1 class="white fs-l3 lh-2 md:fs-xl1 md:lh-1 fw-900">¡Un espacio<br />de 
                <span class="border-b bc-indigo bw-4">aprendizaje</span> dinámico!</h1>
        ...
        <div class="relative flex justify-end items-center w-full md:w-1/3 px-10 md:px-20 md:ml-20"> 
            ...
            <img src="{{ asset('static/assets/img/classroom-join/bg-12.png') }}" alt="girl_vr" class="max-h-60vh object-cover md:max-h-full" width="600" height="300"> 
        </div>
    </section>
            ...
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                        data-feather="file-text" class="w-l5"></i></div>
                        <h4 class="white fw-600 fs-m3 mb-5">Respaldo de los examenes</h4>
                        <div class="indigo-lightest fw-600 fs-m1 lh-3 opacity-50">Te permite guardar tus exámenes en la nube para que puedas acceder a ellos desde cualquier dispositivo.</div>
                    </div>
                </div>
                <div class="w-100pc md-w-40pc">
                    <div class="br-8 p-5 m-5">
                        <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                            data-feather="users" class="w-l5"></i></div>
                            <h4 class="white fw-600 fs-m3 mb-5">IA integrada</h4>
                            <div class="indigo-lightest fw-600 fs-m1 opacity-50">Utiliza la inteligencia artificial para la retroalimentación personalizada en los exámenes y evaluaciones de los estudiantes.</div>
                        </div>
                    </div>
                    <div class="w-100pc md-w-40pc">
                        <div class="br-8 p-5 m-5">
                            <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                                ...
                                <h4 class="white fw-600 fs-m3 mb-5">Cursos y contenido extra</h4>
                                <div class="indigo-lightest fw-600 fs-m1 opacity-50">Acceso a una biblioteca de cursos y recursos educativos adicionales para complementar el aprendizaje.</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <!--title course-->
                <div class="flex justify-center items-center mb-5" id="cursos">
                    <h1 class="white fs-l3 fw-900"><span class="border-b bc-indigo bw-4"> Cursos</span></h1>
                </div>
                ...
                <section class="relative bg-indigo-lightest-10" >
                    ...
                    <div id="slider-1">
                        <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center" style="background-image: url('{{ asset("static/assets/img/home/developer.jpg")  }}'); background-size:cover; background-position: center center;">
                            <h2 class="white fs-l3 fw-900">Curso de Desarrollo Web</h2>
                            <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Aprende las habilidades esenciales para construir sitios web modernos.</p>
                            <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Inscribirse</a>
                        </div>
                        <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center" style="background-image: url('{{ asset("static/assets/img/home/marketing.png")  }}'); background-size:cover; background-position: center center;">
                            <h2 class="white fs-l3 fw-900">Marketing Digital</h2>
                            <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Domina las estrategias de marketing para promocionar tu negocio en línea.</p>
                            <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Inscribirse</a>
                        </div>
                        <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center" style="background-image: url('{{ asset("static/assets/img/home/animal.jpg")  }}'); background-size:cover; background-position: center center;">
                            <h2 class="white fs-l3 fw-900">Diseño Gráfico</h2>
                            <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Desarrolla tu creatividad y crea diseños impresionantes para cualquier proyecto.</p>
                            <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Inscribirse</a>
                        </div>
                    </div>
                    ...
                    <ul class="absolute list-none w-100pc flex justify-between top-50pc">
                        ...
                        <section class="p-10 md-py-10">
                            <div class="w-100pc md-w-70pc mx-auto py-10">
                                ...
                                Empieza a invertir en tu <span class="border-b bc-indigo bw-4">futuro</span>, ¡Mejora tu <span class="border-b bc-indigo bw-4">educación!</span></h2>
                            </div>
                        </section>
                        ...
                        <section class="py-l10">
                            ...
                            <div class="flex justify-center items-center mb-5">
                                <h1 class="white fs-l3 fw-900"><span class="border-b bc-indigo bw-4">Recursos</span></h1>
                            </div>
                            ...
                            <div class="flex flex-column md-flex-row md-w-80pc mx-auto">
                                <div class="w-100pc md-w-50pc">
                                    <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                                        ...
                                        Estudiantes</div>
                                        <div class="indigo-lightest fw-600 fs-m1">Te ofrecemos una forma flexible de aprender que se adapta a ti. Podras tomar cursos de calidad con expertos, hablar con otros estudiantes y recibir consejos personalizados. Además, contaras con acceso a recursos digitales, ahorraras tiempo y dinero, y podras aprender a tu ritmo.</div>
                                    </div>
                                </div>
                                <div class="w-100pc md-w-50pc">
                                    <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                                        <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                                        Docentes</div>
                                        <div class="indigo-lightest fw-600 fs-m1">Te ofrecemos herramientas para que tus clases sean más interactivas, podras comunicarte mejor con tus alumnos, y puedas gestionar las tareas de forma más eficiente. También te ofrecemos información sobre el rendimiento de tus alumnos.</div>
                                    </div>
                                </div>
                            </div>
                        </section>
...
<section>
    <div class="p-10 flex flex-wrap">
        <div class="w-100pc md-w-50pc">
            <div class="p-5">
                <h4 class="white fw-800 fs-l3 mb-5">¿Te interesa comprar un curso?</h4>
                <div class="indigo-lightest fw-600 fs-m1 opacity-50">
                <h4>¡Si consideras comprar uno de nuestos cursos podras acceder a mejor contenido dentro de nuestra plataforma con funciones unicas!
                </h4>
            </div>
...
<div class="w-100pc md-w-25pc">
    <div class="m-3 p-5 br-8 bg-white overflow-hidden">
        <div class="p-3">
            <h3 class="indigo h-1">Cursos Gratis</h3>
        </div>
        <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
            <div>
                <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                <span class="opacity-50 black">Acceso libre y sin inversión inicial.</span>
            </div>
            <div>
                <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                <span class="opacity-50 black">Posibilidad de probar un curso antes de invertir.</span></div>
                <div>
                    <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                    <span class="opacity-50 black">Amplio acceso a diferentes temas academicos.</span></div>

                        </div>
                        <div class="p-3">
                            <button class="button full bg-indigo  hover-opacity-100 hover-scale-up-1 ease-300">¡Iniciar!</button>
                        </div>
                    </div>
                </div>
                <div class="w-100pc md-w-25pc">
                    <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                        <div class="p-3">
                            <h3 class="indigo">Curso Privado</h3>
                        </div>
                        <div class="p-3 black fw-400 fs-s1 lh-5">
                            <div>
                                <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                                <span class="opacity-50">Calidad y profundidad del contenido.</span></div>
                                <div>
                                    <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                                    <span class="opacity-50">Acceso a recursos y herramientas adicionales.</span></div>
                                    <div>
                                        <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                                        <span class="opacity-50">Atención personalizada de profesores y tutores.</span></div>
                                            </div>
                                            <div class="p-3">
                                                <button class="button full bg-indigo white hover-opacity-100 hover-scale-up-1 ease-300">¡Iniciar!</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<section class="p-10 md-p-l5">
    ...
    <!--title testimonials-->
    <div class="flex justify-center items-center mb-5">
        <h1 class="white fs-l3 fw-900"><span class="border-b bc-indigo bw-4"> Testimonios</span></h1>
    </div>
        ...
        <div class="px-3">
            <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                ...
                <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">
                    "La interfaz es intuitiva y fácil de usar, tanto para estudiantes como para profesores. 
                    Recomendamos encarecidamente este sistema a cualquier institución educativa que busque una solución moderna y eficaz."
                </p>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">
                        "El sistema ha mejorado significativamente la comunicación y la colaboración 
                        entre nuestros estudiantes y profesores. Las herramientas de aprendizaje interactivas son 
                        excelentes."
                    </p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                            src="https://randomuser.me/api/portraits/women/75.jpg" alt=""></div>
                            <div class="ml-4 fs-s1">
                                <div class="indigo-lightest">John Doe</div>
                                <div class="indigo-lightest opacity-20">Director, ABC School</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="px-3">
                    <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                        <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                        <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">
                            "Como estudiante, he encontrado el sistema de aulas virtuales increíblemente útil. 
                            Me permite acceder a los materiales del curso en cualquier momento y lugar.
                        </p>
                        <div class="flex items-center my-5">
                            <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="https://randomuser.me/api/portraits/women/22.jpg" alt=""></div>
                                <div class="ml-4 fs-s1">
                                    <div class="indigo-lightest">Jane Smith</div>
                                    <div class="indigo-lightest opacity-20">Estudiante, DEF University</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="px-3">
                        <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                            <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                            <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">
                                "La capacidad de personalizar las aulas virtuales ha sido increíble. 
                                Podemos crear un entorno de aprendizaje único para cada curso, 
                                lo que ha mejorado la participación y el éxito de nuestros estudiantes."
                            </p>
                            <div class="flex items-center my-5">
                                <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                    src="https://randomuser.me/api/portraits/men/82.jpg" alt=""></div>
                                    <div class="ml-4 fs-s1">
                                        <div class="indigo-lightest">David Jones</div>
                                        <div class="indigo-lightest opacity-20">Profesor, GHI College</div>
                                    </div>
                                </div>
                            </div>
                        </div>
