					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								...
								<tr> 
									<td>
										<img src="{{ Storage::url($row->classroom->foto) }}" alt="foto aula" class="avatar avatar-xs pull-up rounded-circle">
										</li>
									</td>
									<td>{{ $row->classroom->nombre }}</td>
									<td>{{ $row->classroom->materia->nombre }}</td>
									<td>{{ $row->classroom->tareas_count }}</td>
									<td width="90">
										<div class="dropdown">
											...
											<ul class="dropdown-menu">
												<li><a class="dropdown-item" href="{{ route('tareas-estudiante',['id'=>$row->classroom->id]) }}"><i class='bx bx-clipboard'></i> Lista de tareas</a></li>
											</ul>
										</div>								
									</td>
								</tr>
