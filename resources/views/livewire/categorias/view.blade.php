				...
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="d-flex justify-content-start">
							<img src="{{ asset('static/assets/img/others/categoria.gif') }}" width="44" height="44">
							<h4 class="mt-2">Listado De Categorias</h4>
						</div>
						...
						<div class="w-25 input-group input-group-merge">
							...
							<input type="text" wire:model='keyWord' class="form-control" placeholder="Buscar categorias..." aria-label="Search..." aria-describedby="basic-addon-search31" name="search" id="search"/>
						</div>
